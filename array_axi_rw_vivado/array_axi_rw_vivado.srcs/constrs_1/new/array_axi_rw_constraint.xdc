...
## Switches
set_property PACKAGE_PIN V17 [get_ports {size[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[0]}]
set_property PACKAGE_PIN V16 [get_ports {size[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[1]}]
set_property PACKAGE_PIN W16 [get_ports {size[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[2]}]
set_property PACKAGE_PIN W17 [get_ports {size[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[3]}]
set_property PACKAGE_PIN W15 [get_ports {size[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[4]}]
set_property PACKAGE_PIN V15 [get_ports {size[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {size[5]}]
...
set_property PACKAGE_PIN L1 [get_ports {rsta_busy}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rsta_busy}]
